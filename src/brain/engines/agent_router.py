...
INTENT_KEYWORDS: Dict[IntentType, List[str]] = {
    ...
    IntentType.MOODBOARD: ["мудборд", "moodboard", "референсы", "визуал", "концепт", "палитра", "стилистик", "образ"],
    IntentType.MARKETING: [
        "продвижен", "маркетинг", "трафик", "реклам", "таргет", "упаковк", "аудитори", "позиционирован", "воронк"
    ],
    IntentType.PROFILE_AUDIT: ["шапк", "аудит", "аккаунт", "профиль", "биографи", "оформлен", "визитк"],
